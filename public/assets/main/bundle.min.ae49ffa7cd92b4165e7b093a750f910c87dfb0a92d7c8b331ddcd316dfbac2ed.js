(() => {
  ...
  // ns-hugo-imp:C:\Users\ismae\OneDrive\Documentos\CURSOS\010 NUNSYS - IFC70 IA\PROYECTOS\PROYECTOS-MICRO\011 TORNEM_A_CASA\themes\bootstrap\assets\js\snackbar\index.ts
  var Snackbar = class {
    constructor() {
  ...
  // ns-hugo-imp:C:\Users\ismae\OneDrive\Documentos\CURSOS\010 NUNSYS - IFC70 IA\PROYECTOS\PROYECTOS-MICRO\011 TORNEM_A_CASA\themes\bootstrap\assets\js\actions-panel\index.ts
  ...
  // ns-hugo-imp:C:\Users\ismae\OneDrive\Documentos\CURSOS\010 NUNSYS - IFC70 IA\PROYECTOS\PROYECTOS-MICRO\011 TORNEM_A_CASA\themes\bootstrap\assets\js\app\index.ts
  var App = class {
    constructor() {
  ...
  // ns-hugo-params:C:\Users\ismae\OneDrive\Documentos\CURSOS\010 NUNSYS - IFC70 IA\PROYECTOS\PROYECTOS-MICRO\011 TORNEM_A_CASA\themes\bootstrap\assets\js\code\code-block.ts
  var code_block_default = { baseURL: "http://localhost:1313/", breadcrumb: true, carouselpostcount: 5, color: "auto", counttaxonomyposts: false, customcss: [], customjs: [], dateformat: ":date_long", description: "Mi sitio web con Hugo", diagram: false, docsnav: { reducefontsize: true }, featuredpostcount: 5, fixedheader: true, fullwidth: false, mainsections: ["posts", "docs"], palette: "blue", palettes: ["blue", "blue gray", "brown", "cyan", "green", "indigo", "orange", "pink", "purple", "red", "teal", "yellow"], pinnedpost: true, pinnedpostcount: 1, postdate: true, poweredby: true, readingtime: true, recentpostcount: 5, relatedpostcount: 5, sass_transpiler: "libsass", searchbar: true, sidebartaxonomies: ["series", "categories", "tags", "authors"], social: { github: "", twitter: "" }, taxonomypaginate: 10, taxonomypostcount: 3, titlecase: false, titleseparator: "-", tocwordcount: 280, viewer: true };

  // ns-hugo-imp:C:\Users\ismae\OneDrive\Documentos\CURSOS\010 NUNSYS - IFC70 IA\PROYECTOS\PROYECTOS-MICRO\011 TORNEM_A_CASA\themes\bootstrap\assets\js\code\code-block.ts
  var CodeBlock = class {
    constructor(element) {
      ...
      __publicField(this, "maxLines", 7);
      __publicField(this, "lineNos", true);
      this.element = element;
      this.pre = element.querySelector("pre");
      this.code = this.pre.querySelector("code");
      if (code_block_default.codeblock.maxlines) {
        this.maxLines = code_block_default.codeblock.maxlines;
      }
      if (code_block_default.codeblock.linenos !== void 0) {
        this.lineNos = code_block_default.codeblock.linenos;
      }
    }
    run() {
      this.wrap();
  ...
  var code_block_default2 = CodeBlock;

  // ns-hugo-imp:C:\Users\ismae\OneDrive\Documentos\CURSOS\010 NUNSYS - IFC70 IA\PROYECTOS\PROYECTOS-MICRO\011 TORNEM_A_CASA\themes\bootstrap\assets\js\code\index.ts
  var Code = class {
    run() {
      document.addEventListener("DOMContentLoaded", () => {
        document.querySelectorAll(".highlight").forEach((element) => {
          const block = new code_block_default2(element);
          block.run();
        });
      });
    }
  ...
  // ns-hugo-imp:C:\Users\ismae\OneDrive\Documentos\CURSOS\010 NUNSYS - IFC70 IA\PROYECTOS\PROYECTOS-MICRO\011 TORNEM_A_CASA\themes\bootstrap\assets\js\docs\catalog.ts
  var Catalog = class {
    run() {
  ...
  // ns-hugo-imp:C:\Users\ismae\OneDrive\Documentos\CURSOS\010 NUNSYS - IFC70 IA\PROYECTOS\PROYECTOS-MICRO\011 TORNEM_A_CASA\themes\bootstrap\assets\js\docs\index.ts
  var Docs = class {
    run() {
  ...
  // ns-hugo-imp:C:\Users\ismae\OneDrive\Documentos\CURSOS\010 NUNSYS - IFC70 IA\PROYECTOS\PROYECTOS-MICRO\011 TORNEM_A_CASA\themes\bootstrap\assets\js\font-size-selector\index.ts
  var FontSizeSelector = class {
    constructor() {
      __publicField(this, "key", "font-size");
    ...
    getSize() {
      const size = local_storage_default2.getItem(this.key);
      if (size) {
        return size;
      }
      return "md";
    ...
    setSize(value) {
      ...
      local_storage_default2.setItem(this.key, value);
      this.items.forEach((ele) => {
  ...
  // ns-hugo-imp:C:\Users\ismae\OneDrive\Documentos\CURSOS\010 NUNSYS - IFC70 IA\PROYECTOS\PROYECTOS-MICRO\011 TORNEM_A_CASA\themes\bootstrap\assets\js\form-validator\index.ts
  ...
  // ns-hugo-imp:C:\Users\ismae\OneDrive\Documentos\CURSOS\010 NUNSYS - IFC70 IA\PROYECTOS\PROYECTOS-MICRO\011 TORNEM_A_CASA\themes\bootstrap\assets\js\iframe\index.ts
  var IFrame = class {
    run() {
      this.load();
      this.fullscreen();
  ...
  // ns-hugo-imp:C:\Users\ismae\OneDrive\Documentos\CURSOS\010 NUNSYS - IFC70 IA\PROYECTOS\PROYECTOS-MICRO\011 TORNEM_A_CASA\themes\bootstrap\assets\js\loading-bar\index.ts
  ...
  // ns-hugo-imp:C:\Users\ismae\OneDrive\Documentos\CURSOS\010 NUNSYS - IFC70 IA\PROYECTOS\PROYECTOS-MICRO\011 TORNEM_A_CASA\themes\bootstrap\assets\js\scroller\index.ts
  var Scroller = class {
    constructor() {
      __publicField(this, "btn");
  ...
  // ns-hugo-imp:C:\Users\ismae\OneDrive\Documentos\CURSOS\010 NUNSYS - IFC70 IA\PROYECTOS\PROYECTOS-MICRO\011 TORNEM_A_CASA\themes\bootstrap\assets\js\sidebar-toggle\index.ts
  var SidebarToggle = class {
    constructor(button) {
      this.button = button;
      __publicField(this, "main");
      __publicField(this, "sidebar");
      __publicField(this, "key", "sidebar-toggle");
      __publicField(this, "colClass", "col-xxl-");
    }
    run() {
      if (!this.button) {
        return;
      ...
      this.main = this.sidebar.closest("main");
      this.button.addEventListener("click", () => {
        this.toggle();
      });
      const val = local_storage_default2.getItem(this.key);
    ...
    hide() {
      ...
      local_storage_default2.setItem(this.key, "hide");
    }
    show() {
      this.main.classList.remove("sidebar-none");
      local_storage_default2.removeItem(this.key);
    }
  };
  var sidebar_toggle_default = SidebarToggle;

  // ns-hugo-imp:C:\Users\ismae\OneDrive\Documentos\CURSOS\010 NUNSYS - IFC70 IA\PROYECTOS\PROYECTOS-MICRO\011 TORNEM_A_CASA\themes\bootstrap\assets\js\table-wrapper\index.ts
  ...
  // ns-hugo-imp:C:\Users\ismae\OneDrive\Documentos\CURSOS\010 NUNSYS - IFC70 IA\PROYECTOS\PROYECTOS-MICRO\011 TORNEM_A_CASA\themes\bootstrap\assets\js\toc\index.ts
  var TOC = class {
  ...
  // ns-hugo-imp:C:\Users\ismae\OneDrive\Documentos\CURSOS\010 NUNSYS - IFC70 IA\PROYECTOS\PROYECTOS-MICRO\011 TORNEM_A_CASA\themes\bootstrap\assets\js\rss\index.ts
  var RSS = class {
    run() {
      if (true) {
  ...
  // ns-hugo-imp:C:\Users\ismae\OneDrive\Documentos\CURSOS\010 NUNSYS - IFC70 IA\PROYECTOS\PROYECTOS-MICRO\011 TORNEM_A_CASA\themes\bootstrap\assets\main\js\components.ts
  var components = [];
  var components_default = components;

  // ns-hugo-imp:C:\Users\ismae\OneDrive\Documentos\CURSOS\010 NUNSYS - IFC70 IA\PROYECTOS\PROYECTOS-MICRO\011 TORNEM_A_CASA\themes\bootstrap\assets\js\slide\index.ts
  (() => {
    "use strict";
  ...
  // ns-hugo-params:C:\Users\ismae\OneDrive\Documentos\CURSOS\010 NUNSYS - IFC70 IA\PROYECTOS\PROYECTOS-MICRO\011 TORNEM_A_CASA\themes\bootstrap\assets\js\search\index.ts
  var search_default = { baseURL: "http://localhost:1313/", breadcrumb: true, carouselpostcount: 5, color: "auto", counttaxonomyposts: false, customcss: [], customjs: [], dateformat: ":date_long", description: "Mi sitio web con Hugo", diagram: false, docsnav: { reducefontsize: true }, featuredpostcount: 5, fixedheader: true, fullwidth: false, mainsections: ["posts", "docs"], palette: "blue", palettes: ["blue", "blue gray", "brown", "cyan", "green", "indigo", "orange", "pink", "purple", "red", "teal", "yellow"], pinnedpost: true, pinnedpostcount: 1, postdate: true, poweredby: true, readingtime: true, recentpostcount: 5, relatedpostcount: 5, sass_transpiler: "libsass", searchbar: true, sidebartaxonomies: ["series", "categories", "tags", "authors"], social: { github: "", twitter: "" }, taxonomypaginate: 10, taxonomypostcount: 3, titlecase: false, titleseparator: "-", tocwordcount: 280, viewer: true };

  // ns-hugo-imp:C:\Users\ismae\OneDrive\Documentos\CURSOS\010 NUNSYS - IFC70 IA\PROYECTOS\PROYECTOS-MICRO\011 TORNEM_A_CASA\themes\bootstrap\assets\js\search\index.ts
  (() => {
    "use strict";
    var _a, _b;
    const shortcut = ((_b = (_a = search_default) == null ? void 0 : _a.search) == null ? void 0 : _b.shortcut) === void 0 ? ["/"] : search_default.search.shortcut;
    const keys = {};
    const press = (e) => {
      if (e.type === "keydown") {
        keys[e.key] = 1;
